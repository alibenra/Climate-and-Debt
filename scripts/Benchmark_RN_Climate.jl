...
function default_iteration_RN!(; sigma_ey, rho_y, beta, wc_par_asymm, delta, mu_r,
...
function main_country_RN(country::String)
    ...
    @save "output/sim_bench_RN_climate.jld2" meanBY_sim meanBY_sim_market meanspread_sim medianspread_sim stdspread_sim meanspread_hurr_sim medianspread_hurr_sim gdp_g_h_sim spread_g_h_sim b_g_mean i_x_sim cons_sim spread_sim def_freq_sim hur_freq_sim gdp_mean_store V_g_mean
...
result_bench_RN_climate = main_country_RN("Jamaica")

# Saving model simulations results
V_g_bench_RN_climate = result_bench_RN_climate.V_g_mean
gamma_c = result_bench_RN_climate.gamma_c

@save "output/Vg_sim_bench_RN_climate.jld2" V_g_bench_RN_climate gamma_c
