...
plt = plot_bond_price_schedule_with_gdp(result_1P_RN_climate.b_g_vec, result_1P_RN_climate.q_g, result_1P_RN_climate.gdp_vec, result_1P_RN_climate.meanDebtGDP)
display(plt)
