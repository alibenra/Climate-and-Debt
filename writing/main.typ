...
In order to assess the long-term effectiveness of climate-contingent instruments, we replicate the same baseline quantitative simulations under a climate change scenario. Effectively, hurricane-related parameters are adjusted to reflect an intensification of climate change risks. Hurricane frequency is increased by 29.2% following Bhatia et al. (2018) and hurricane damage is increased by 48.5% as shown by Mejia (2016). These statistics were originally reported by Mallucci (2022) and were taken directly to conduct a similar climate change stress test on the instruments analyzed in this paper.
