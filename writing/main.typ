...
Five years following the onset of the COVID-19 crisis, the world remains on the brink of a debt crisis. The pandemic has left a lasting impact on the fiscal and debt profiles of low- and middle-income countries (LMICs). Emergency policy responses during the pandemic and economic recovery plans in the following years have significantly expanded government spending, pushing sovereigns to increasingly rely on external debt to meet their financing needs, precisely as global interest rates skyrocketed in 2022 and 2023. As a result, LMICs now face substantially higher debt levels than in the previous decade and struggle with an increasingly challenging debt servicing burden, hindering the achievement of their development roadmaps @unctad2024debt. The World Bank’s 2024 International Debt Report highlights that, in 2023, LMICs allocated 3.7 percent of their gross national income to debt service, with 1.1 percent going to interest payments, the highest level recorded in two decades @worldbank2024debt. This rising debt service burden was met with tightening access to liquidity, as the report highlights a pullback of increasingly risk-averse private creditors from LMIC credit markets. The compounded factors have led several economies down the road of debt distress. As of March 2025, the IMF categorized, among 67, 9 low-income countries (LICs) in debt distress, 26 at high risk, 24 at moderate risk, and only 8 at low risk of external debt distress, highlighting the deepening systemic vulnerability across LICs @imf2025licdsa. In this context, LMICs appear ever more vulnerable to the numerous exogenous factors that may worsen their debt burdens, such as further trade fragmentation and unstable geopolitical conflicts @worldbank2024debt. This paper specifically focuses on the potential impact of natural disaster shocks on debt sustainability, especially as the effects of climate change are expected to intensify in the coming years.
\
\

_Climate Crisis -  Debt Doom Loop. _ #h(0.5cm) Natural disasters impose substantial economic and fiscal costs associated with post-disaster relief spending, reconstruction efforts, and lost output @cevik2018naturaldisasters. The literature distinguishes between two types of losses: direct impacts, such as physical destruction of infrastructure and productive assets, and indirect impacts, which include subsequent macroeconomic disruptions in production, employment, consumption, trade flows, and broader recovery dynamics @botzen_economic_2019. As climate change intensifies, natural disaster-related damages are projected to escalate, leading to more frequent and severe economic disruptions, particularly in vulnerable regions. While the least contributors to global emissions @ipcc2023synthesis, low-income countries (LICs) already face the adverse impacts of climate change. The 2021 International Development Association (IDA) Climate Change Special Report issue highlights that over the last decade, LICs have already faced close to eight times as many natural disasters as in the 1980s @worldbank2021ida20. Although advanced economies are also set to suffer from climate change-related damages, emerging markets remain much more at risk due to low fiscal buffers and constrained access to liquidity, two vulnerabilities exacerbated by the current global macroeconomic context. Climate-induced shocks shrink government revenues and raise emergency spending needs, thus straining primary balances and widening external deficits. These weakened fundamentals heighten sovereign risk, which in turn increases the cost of borrowing precisely when additional financing becomes necessary @cevik_this_2022. Empirically, early research shows that a single large-scale natural disaster raises sovereign default risk by about three percentage points @klomp2017flooded, and a 1% increase in climate vulnerability adds over 3% to long-term bond spreads in LMICs @cevik_this_2022. Taken together, climate-related damages and associated rising debt vulnerabilities could interact to produce a feedback loop, which can be referred to as a climate crisis–sovereign debt doom loop @gcf2024debtswaps. As climate change increases physical damage and economic disruptions, vulnerable sovereigns face revenue losses and rising expenditure needs for relief and recovery, often necessitating costly external borrowing at rising risk premia. The subsequent accumulation of debt reduces the fiscal space needed for adaptation and mitigation investment, which leaves countries more exposed to future climate shocks and raises the probability of default in the long term. Overall, the compounding nature of these effects demonstrates the need for systemic financial mechanisms that can not only offer automatic disaster relief but also prevent rising borrowing costs. 

\

_Climate-resilient debt instruments._ #h(0.5cm) As a response to the intensification of natural disasters due to climate change, policymakers are exploring the potential of climate-resilient financial instruments. In the face of exogenous shocks precipitating governments into default, traditional solutions have taken the form of liability management exercises or debt restructuring negotiations with creditors, which seek to make debt servicing more manageable. More recently, certain relief options have sought to specifically address climate-related objectives. Debt-for-climate swaps (DFCS) are among the operations that have come under the spotlight in recent years.  DFCS consist of agreements between a sovereign and its creditors to cancel or refinance a portion of a current debt obligation in exchange for investments in climate resilience plans @gcf2024debtswaps. Recent examples included the Seychelles in 2015, Belize in 2021, and Ecuador and Gabon in 2023 @gcf2024debtswaps. While these operations effectively free up fiscal space in a way that directly addresses the Climate Crisis-Debt Doom Loop, they involve ad-hoc and lengthy negotiations that require strong political will and international coordination between borrowers and creditors who hold competing incentives. As a means of circumventing political limitations and coordination challenges, policymakers and economists have also explored the possibility of relying on financial instruments designed precisely to provide immediate and systematic relief. This paper focuses precisely on two market-based mechanisms that aim to trigger automatic and time-sensitive relief following climate shocks: debt pause clauses (DPCs) and catastrophe bonds (CAT).

_Debt Pause Clauses._ #h(0.5cm) DPCs, also known as natural disaster clauses, climate-resilient clauses, and debt suspension clauses, allow sovereigns to suspend debt payments if a predefined natural disaster occurs temporarily. The standard duration of suspension is between one and two years and may involve the deferral of either coupons, principal payments, or both @centerfordisasterprotection2023pause. Relief is triggered automatically based on parametric criteria relating to the severity of the climate shock @cgdev2023suspension. DPCs are designed to be net present value neutral (NPV), meaning that they defer repayment but do not reduce the amount owed, thus limiting losses for investors @cleary2022naturedebt. In fact, DPCs also imply an increase in debt service following a pause in nominal terms through a mechanism of interest accrual on deferred payments at a pre-agreed interest rate. These instruments aim to ease liquidity constraints by freeing fiscal space for disaster response. This allows governments to prioritize relief efforts over immediate debt repayments. 

_Catastrophe bonds._ #h(0.5cm) CAT bonds offer sovereigns an alternative way to rely on capital markets to mitigate the adverse impacts of natural disasters. From the point of view of the sovereign, CAT bonds can best be described as insurance-like instruments that allow them to shift the financial burden of disasters to investors. In a standard CAT bond framework, the issuer enters into an insurance agreement with a sponsor, usually a Special Purpose Vehicle (SPV), which issues the debt instrument on its behalf @polacek2018catbonds. In the case of sovereigns, the World Bank takes the role of the SPV as the issuing entity @cleary2022naturedebt. In practice, CAT bonds enable sovereigns vulnerable to natural disasters to access recovery funding through investor payouts, contingent upon the occurrence of a predefined trigger event, analogous to the activation mechanism of DPCs. In return, sovereigns commit to a periodic premium payment to investors during non-disaster periods, with the rate set at issuance based on the expected loss associated with a qualifying disaster event @oecd2024catbonds. The payment structure of CAT bonds appeals to investors as it offers an opportunity for portfolio diversification through returns uncorrelated with market-related shocks while insulating them from sovereign macroeconomic risks, given that issuance is managed by the World Bank rather than the sovereign. Compared to DPCs, CAT bonds do not form part of the debt stock and do not modify the payment structure of the sovereign’s debt contracts. Akin to an insurance mechanism, CAT bonds support sovereigns by offering immediate post-disaster liquidity, thus intervening on the budgetary front rather than through direct alleviation of debt servicing obligations.

DPCs and CAT bonds are relatively recent instruments and have few real-world implementations. Only three countries have adopted DPCs so far, namely Grenada, Barbados, and the Bahamas @cpi2025climate. Grenada became the first country to effectively activate such a clause as recently as August 2024, suspending USD 12 million in interest for one year on its 2015 USD 112 million bond following Hurricane Beryl @ft2024grenada. Some advanced economies, including Spain, are now advocating for a wider acceptance and adoption of DPCs by bilateral creditors to help vulnerable countries cope with climate-related disasters @ft2024debtclauses. CAT bonds, on the other hand, have seen a relatively wider adoption so far through the World Bank’s Capital at Risk Notes program. The program is designed to support at-risk economies enter into CAT bond agreements. Among other operations, the World Bank coordinated the issuance of a USD 185 million CAT bond on behalf of Jamaica in 2021 to provide coverage against tropical cyclone losses over a two-year period and has also facilitated multiple CAT bond transactions for the Government of Mexico since 2006, and most recently in 2025, covering a range of natural disasters including hurricanes, storms, floods, earthquakes, and volcanic eruptions @worldbank2021jamaicabond @worldbank2020catbond @worldbank2024pacificbond.

While DPCs and CAT bonds can theoretically alleviate short-term fiscal stress following a disaster, their state-contingent nature introduces significant repayment uncertainty. Investors will tend to price this uncertainty, which could lead to higher risk premia and potentially more expensive future borrowing. As such, although designed to mitigate sovereign risk stemming from natural disasters, climate-contingent instruments have complex and unconventional structures that may introduce sufficiently high-risk premia to offset their intended benefits. This represents the core tension with regard to the effectiveness of climate-resilient instruments. This dynamic reflects broader findings in the literature on state-contingent debt, which has attributed the scarcity of state-contingent instruments to persistent novelty and uncertainty risk premia associated with their contingent design @roch_uncertainty_2023 @igan2022premia.

\

_Research questions._ #h(0.5cm) *Can climate-contingent debt instruments improve welfare and debt sustainability in vulnerable economies? Between debt pause clauses (DPCs) and catastrophe bonds (CAT bonds), which instrument design provides the most effective solution for mitigating sovereign risk in disaster-prone economies?* This paper aims to address the underlying tension between the intended benefits and potential drawbacks of climate-resilient financial instruments. Specifically, it investigates whether the relief provided by DPCs and CAT bonds effectively reduces borrowing costs and default risk following natural disasters, or whether the repayment uncertainty they introduce undermines their practicality and could, in fact, increase sovereign financing costs. A secondary goal is to precisely compare the relative effectiveness of DPCs compared to insurance-based mechanisms like CAT bonds to determine which is better suited for managing disaster-related sovereign risk in countries highly exposed to climate risks.
...
In this paper, we seek to evaluate the impact of natural disasters and mitigating financial instruments through a quantitative model of sovereign default. We first solve for a benchmark model following the #cite(<eaton_debt_1981>, form:"prose") and #cite(<arellano2008default>, form:"prose") specifications. We incorporate long-term bonds à la #cite(<hatchondo_long-duration_2009>, form:"prose") in order to account for the requirements of the debt pause clause extension which necessitates tracking the dynamics of potential debt repayment freezes across a single instrument throughout several time periods in case of hurricane occurrences. The model is calibrated to Jamaican data. The case of Jamaica was chosen due to the fact that it is a hurricane-prone economy that has already benefited from CAT bonds through the World Bank program @worldbank2021jamaicabond. Additionally, key calibration data and parameters were already computed by #cite(<mallucci_natural_2022>, form:"prose"), which allows for a potential comparative analysis. As such, the natural disaster that is explored in the calibration of this model is hurricane risk.

In order to track hurricane states and account for their economic impacts in terms of output loss, we define an output process that involves a multiplicative distortion of the standard autoregressive income process adopted in the sovereign default literature. More specifically, we define a hurricane shock process that only materializes with a set probability, fixed to reflect the annual likelihood of a major hurricane in Jamaica between 1980 and 2019, as reported by #cite(<mallucci_natural_2022>, form:"prose") using data from the National Oceanic and Atmospheric Administration (NOAA). In hurricane states, the output process remains equal to the income process value. In the event of a hurricane, income is multiplicatively scaled by a log-normal i.i.d. shock with log-mean zero, truncated at one to prevent output gains. The exponentiated log shock is then rescaled in a way that allows the expected value of the shock variable to match the empirical mean output loss observed in Jamaica following a major hurricane. This multiplicative structure has the advantage of separating macroeconomic fluctuations from climate-induced disasters, allowing tractable modeling of sovereign default risk under both business cycle and climate risks. Yet, it does not necessarily allow to model the lasting impacts of a natural disaster on overall output. As the main objective of this paper is to isolate the role of climate-resilient instruments in stabilizing sovereign risk in the face of a natural disaster, this concern is minimized as a lasting hurricane shock on output would only change the scale of the response of such instruments rather than their very nature. However, we acknowledge the usefulness of exploring an alternative output process specification in which hurricane shocks affect income for multiple periods to account for more faithful modeling of the intensification of disaster losses due to climate change. 

The benchmark model only differs from the #cite(<eaton_debt_1981>, form:"prose") and #cite(<arellano2008default>, form:"prose") specifications through the incorporation of hurricane shocks as a multiplicative distortion of output in the government resource constraints. As in #cite(<hatchondo_long-duration_2009>, form:"prose"), the borrower is a benevolent government, represented in a small open economy which trades LT bonds with risk-neutral foreign creditors. The assumption of risk-neutrality of investors is useful to allow to isolate the impact of climate-contingent debt instrument designs on default risk. Additionally, it could be argued to be a reasonable assumption given the fact that international investors who purchase small economy bonds have deep pockets and well-diversified portfolios against idiosyncratic risks such as hurricane risk. LT bonds provide an infinite stream of coupon payments that continues until default occurs, with coupon amounts declining at a constant geometric rate over time. The decay parameter is selected to match the average maturity of Jamaican bonds, as in #cite(<mallucci_natural_2022>, form:"prose"). At each period, the government must choose whether to repay or to default on its debt, and select an amount of additional debt it wishes to contract and to be repaid in the next period. In the benchmark model, these bonds are non-contingent and are priced by the risk-neutral investors. Default comes at a cost, defined following the #cite(<eaton_debt_1981>, form:"prose") and #cite(<arellano2008default>, form:"prose") specifications. Defaulting implies a cost on output in the form of an asymmetric endowment loss structure. The sovereign is excluded from the markets and may only rejoin with a set probability. 
...
In the benchmark model, we consider a small open economy populated by identical risk-averse households. The government of the economy seeks to maximize their discounted expected lifetime utility from consumption given by
$ E_0[sum^(infinity)_(t=0) beta^t u(c_t)] $
where $0 < beta < 1$ refers to the subjective discount factor.

The periodic utility of households displays a constant coefficient of relative risk aversion, represented by $gamma >0$, such that:
$ u(c_t) = frac(c_t^(1-gamma), 1-gamma) $ \

_Total Output Process._ #h(0.5cm) In each period, households receive a stochastic stream of consumption goods $y_t$, which will represent the government's endowment. The government's income process is assumed to be a log-normal AR(1) process such that:
$ log(y_t) = rho_y log(y_(t-1)) + epsilon^y_t $
where $epsilon^y_t ~^(text("iid")) 𝒩(0, sigma^2_y)$ and $abs(rho_y)<1$

In this framework, the output depends not only on the income process and the associated exogenous business cycle fluctuations and macroeconomic shocks, but also on hurricane risk. In order to represent the impact of hurricane risk on output, it is introduced as a multiplicative distortion of income. Effectively, hurricane shock $h_t$ directly scales output each period, such that realized output is:
$ x_t = y_t dot h_t $
Formally, the hurricane shock process is defined as:
$ h_t = cases(
  1  #h(3.5cm) "with probability" 1 - pi_H, 
  min{macron(h) dot exp(𝓁_t), 1} #h(0.45cm) "with probability" pi_H
) $
where:
- $𝓁_t ~^text("iid") 𝒩(mu_𝓁, sigma^2_𝓁)$ is a log-loss shock drawn from a normal distribution
...
In order to ensure that the expected loss factor is properly centered, we impose the normalization $mu_𝓁 = -frac(1, 2)sigma_𝓁^2$, which implies $#math.bb("E") [exp(𝓁_t)] = 1$. The goal of this step is to ensure that $exp(𝓁_t)$ does not bias $h_t$ upward or downward on average in order to capture the mean hurricane loss entirely through $macron(h)$ to match the empirical average loss. 
...
Economically, the truncation operator reflects the fact that even when a hurricane hits, it might not cause observable damage to economic activities, which is captured by $h_t = 1$ even when a hurricane hits with probability $pi_H$. Additionally, this formulation will also be useful in the extension to climate-contingent instruments, as it could be interpreted to reflect the uncertainty revolving around their trigger. Parametric triggers adopted in many designs of both DPCs and CAT bonds are only activated if a certain threshold is met under very specific criteria @worldbank2022resilience. Therefore, even if a rare and major hurricane hits, it may not activate payouts. This conservative modeling approach preserves the log-normal shape of disaster risk while maintaining interpretability and tractability in both standard and contingent debt environments.

Therefore, to clearly signal hurricane states that lead to the trigger of a pause clause or a CAT bond, we define an indicator variable $s_H$ that captures whether hurricane damage is severe enough to lower output in a given period. This aligns with the typical trigger structure of climate-contingent instruments, where payouts are activated only if economic damage surpasses a threshold and not automatically. Effectively, $s_H = 1$ does not occur every time a hurricane hits with probability $pi_H$, but only when it causes output loss. Formally:
$
  s_H = cases(
    1 #h(0.5cm) "if" h < 1,
    0 #h(0.5cm) "if" h = 1
...
Using the law of total probability, the expected value of $s_H$ will thus be:
$
  #math.bb("E") [s_H] =  #math.bb("P") (s_H = 1) = pi_H dot #math.bb("P") (h_t < 1 | "hurricane")
$
By the definition of the $min$ operator, $h_t < 1$ only if:
$
...
1. First, it chooses whether to default or not. The choice of default has two major implications for the sovereign
  - If default is chosen, the government suffers from an associated cost on output, represented by an endowment loss function. Following #cite(<arellano2008default>, form:"prose"), the default cost on output function takes an asymmetric form:
  $ y^("def") = cases(
...
2. Second, in the case of repayment, it chooses the next-period debt position to aim for in the current period. 
\

_Long-Term Bonds Framework._ #h(0.5cm) We assume that bonds are LT à la #cite(<hatchondo_long-duration_2009>, form:"prose"). This means that a bond issued in period t promises an infinite stream of coupons which decreases at a constant rate $psi$. Therefore, one unit of bond issued in period t implies a promised payment of 1 at $t+1$, $(1-psi)$ at $t+2$, $(1-psi)^2$ at t+3... As such, the promised cashflow of a bond is $(1 - psi)^(j-1)$ in period $t+j$ for all $j>= 1$. This specification allows to model the effective maturity through the constant decrease in $psi$. If $psi = 0$, the bond would correspond to a perpetuity. If $psi = 1$, the bond would effectively become a one-period bond. If $0 <psi < 1$, the framework would model decaying-coupon LT bonds. 
...
\
Therefore, new issuance at the next period corresponds to the difference between the choice of next-period debt position $b'$ and current debt position $b$ given the decision to default and the decaying structure of LT bonds, such that :
$ i = b' - (1-d)(1- psi)b  $
...
#box[Recognizing the sum of an infinite geometric series:
$ "PV"(r) & = sum^(infinity)_(j=1) frac(1, 1+r) (frac(1-psi, 1+r))^(j-1) \
 & = frac(1, 1+r) dot (frac(r+ psi, 1+r))^(-1) \
 & = frac(1, r+psi)
$]
\
We can thus define an expression of the value of the bond equal to its promised cashflow sequence, such that $q = frac(1, r+psi)$. Using this definition, we can derive an expression of the bond duration following the Macaulay definition used by #cite(<hatchondo_long-duration_2009>, form:"prose"). As such, the bond's duration is defined as:
$ D = sum^(infinity)_(j=1) w_j times j $
where $w_j = frac(1,q) dot frac((1-psi)^(j-1),(1+r)^j)$ such that: 
$ sum^(infinity)_(j=1) w_j & = sum^(infinity)_(j=1) frac(1,q) dot frac((1-psi)^(j-1),(1+r)^j) \
& = frac(1,q) dot frac(1, r+psi) \
& = 1
$
$w_j$ thus refers to the weights which represent the fraction of the bond's value q from the cashflow sequence promised at date $j$.
\
...
D & = frac(1+r, r + psi)
$
As such, for a one-period coupon bond, $psi = 1$ and $D=1$, while for long-term bonds in the Hatchond-Martinez framework, $0<psi <1$ and $D>1$.
...
In the default branch, the government does not repay its debts, suffers from default output costs, and is excluded from international markets. However, it may still be subject to a hurricane shock. Therefore, its resource constraint becomes:
$ c = y^("def") dot h $
...
$
In the repayment branch, the government chooses the optimal size of the next-period asset position to maximize utility, given the expected value in next period taking into account that it will accordingly renew its choice between future repayment and future default.
...
Following #cite(<arellano2008default>, form:"prose"), the government's default policy can be described through repayment and default sets.
\
*Definition 1.* #h(0.5cm) Let $D(b)$ denote the default set which consists of the equilibrium set of exogenous state pairs $ (y, h)$ for which default is optimal when the government's asset holdings are $b$. Formally:
$
...
The equilibrium default sets are related to the functional form fo default as follow:
...
DPCs and CAT bond payouts are activated following a hurricane, only if the cost of damage (or the climatic characteristics) of the disaster exceeds a pre-defined threshold @centerfordisasterprotection2023pause @cleary2022naturedebt. This requirement is satisfied by the condition that the multiplicative distortion associated with the hurricane shock process at a given period lowers output, which means that $h < 1$. As such, the materialization of hurricane damage will be denoted by the indicator variable $s_H$, as defined in Section 2.
...
A pause clause in this framework consists in a deferral of coupon payments by one or two periods, given the pre-agreed-upon duration of relief. During the relief period, interest will accrue at contractual rates on the asset position at the risk-free rate $r$ in order to compensate investors during the deferral period. Additionally, all deferrals need to be NPV-neutral. In practice, all deferred interest and coupon amounts would be capitalized into principal @cleary2021disasterclause. In this framework, this dynamic is represented by a shift in the promised cashflow by one or two periods, rescaled by the appropriate interest accrual term. 

\

=== Modeling the cashflow sequence under a DPC contract
\
#box[For a plain vanilla bond, a bond issued at time $t$ implies a promised cashflow sequence of:
- *At t+1:* $1$
- *At t+2:* $1-psi$
- *At t+3:* $(1-psi)^2$
- *At t+4:* $(1-psi)^3$
...
The key modification of the benchmark model in the case of a 1PC consists in accounting for the activation of a pause clause in case of significant hurricane damage. The general government value function is modified to account for the possibility of an alternative repayment branch in the case of a significant hurricane shock. In the event of the materialization of hurricane damage, the government will automatically be set on the course of a relief period as specified in the DPC contract. As such, in the case of a 1PC, the government will be in either of two situations at the beginning of each period. If the pause clause trigger is not activated ($s_H = 0$), then the government will face the baseline choice between the standard value of repayment and the value of default. However, if the pause clause trigger is activated ($s_H = 1$), then the government will choose between the standard value of default and the value of entering a relief state. In the pause state, interest accrues on the bond’s resale value despite the suspension of coupon payments, which are expected to resume in the following period. Formally, let $V^("o1") (b,y,h)$ be defined as:
...
- The first branch, or *no activation branch*, relates to the case in which no clause activation is expected in the next period ($s_H ' = 0$). In this case, investors price the bond according to the standard repayment expectations. The price will thus reflect both the next-period coupon and the expected resale value of the bond (which summarizes the entire stream of expected future coupon repayments).
...
#box[Formally, the bond price satisfies:
$
...
\
Both cases can then be joined in a general pricing equation for a two-period pause clause, taking into account the distinction between pricing anticipations in the case of no current DPC activation, as well as in the scenario of an already undertaken 2PC. Formally:
$
...
We now turn to the case of CAT bonds, another class of climate-contingent instruments, which, unlike pause clauses, transfer natural disaster risk to lenders through an insurance-like mechanism. CAT bonds are essentially distinct instruments from standard sovereign bonds. While DPCs are embedded into sovereign bonds, directly modifying their coupon payment structure in the event of a disaster, CAT bonds are issued in parallel and do not modify the cashflow of the plain-vanilla bonds instruments explored in the benchmark model. 

Another fundamental difference lies in the fact that CAT bonds are not issued by the government itself. In fact, investors purchase these instruments directly from a third-party institution, which could either be an SPV or the World Bank acting as the issuer on behalf of the sovereign. As such, the government's involvement in CAT bonds is limited to a set of insurance-like financial flows:
...
CAT bonds are thus modeled exclusively through this insurance logic, without the explicit representation of the SPV or the World Bank as financial intermediaries. Importantly, CAT bonds do not contribute to the government's outstanding debt stock. They are best understood as one-period insurance contracts which are renewed each period and imply either a payout or a premium payment depending on the realization of the disaster trigger. This repeated renewal structure serves as a tractable proxy for multi-year CAT bond programs observed in practice. The premium is defined as the spread of the CAT bond and is priced at the beginning of each period. 

Finally, it is worth emphasizing that the CAT/insurance contract also applies in the default states. As such, investors perceive CAT bonds as instruments uncorrelated with the sovereign’s macroeconomic fundamentals and price their premiums based solely on the exogenous hurricane risk. This reflects a simplifying assumption aligned with the fact that CAT bonds are not part of the sovereign's debt stock and are therefore not subject to default or restructuring negotiations. Moreover, empirical evidence suggests that sovereigns are unlikely to default on obligations involving multilateral institutions such as the World Bank @wicht_seniority_2025 @brumunoz2023multilateral.

Nevertheless, the assumption that CAT bond flows continue during autarky may overstate their hedging benefits, particularly in severe economic crises where a sovereign might renege on CAT bond obligations alongside default on conventional debt. Future work could address this concern by allowing sovereign default on CAT bond premium payments during periods of debt distress. This modification would fundamentally alter the valuation of CAT bonds by investors, as it would imply a pricing framework that also incorporates the sovereign’s macroeconomic fundamentals. This, in turn, would undermine CAT bonds' appeal as risk-diversifying assets that, under the current setup, are designed to be uncorrelated with sovereign risk.
...
_CAT bond premium._ #h(0.5cm) Premium rates are defined by the spread of a CAT bond, $Pi^("CAT")$, which is determined at issuance @oecd2024catbonds. The spread corresponds to the difference between the yield on the country's CAT bond and the risk-free rate. The country-specific CAT bond yield is calculated as the inverse of the bond’s discounted price, $1 + r^("CAT") = frac(1, q^("CAT"))$. Formally:
$
 Pi^("CAT") & = r^("CAT") - r  = frac(1, q^("CAT")) - 1 - r 
$

Given that investors are risk-neutral and that CAT bonds are uncorrelated with sovereign fundamentals, the CAT bond price can be modeled directly as the expected loss from a hurricane, corresponding to the full principal, based solely on the probability of the trigger event #footnote[In a model with risk-averse investors, CAT bond pricing would also take into account lenders' risk premia in addition to the measurement of expected loss]. As a one-period bond, CAT bond price represents the discounted expected payoff of investors given the probability of an activation of a damaging hurricane trigger. 
$
  q^("CAT") = frac(1, 1+r) dot #math.bb("E") [1 - s_H]
$

Note that, in this framework, CAT bonds are modeled as a sequence of independent one-period contracts. This effectively approximates the multi-period structure of CAT bonds observed in practice. It also simplifies implementation while retaining the core insurance logic. Additonally, since hurricane shocks are assumed to be exogenous and empirically calibrated to match observed hurricane frequency and average loss severity, the expectation $#math.bb("E") [s_H]$ remains constant across periods in the baseline framework. As a result, the CAT bond premium is also constant, varying only when the frequency or intensity of hurricane-related losses is altered. This possibility is explored in the climate change scenario analysis presented in the quantitative evaluation section of the paper.
...
#box[Similarly, the bond pricing equation remains unchanged from the benchmark model, as investors continue to price the same plain-vanilla sovereign bonds. CAT bonds do not modify the bond's payment structure and therefore do not directly affect its valuation under risk-neutral pricing.
$
  q(b', y) = frac(1, 1+r) dot #math.bb("E")_(y', h' | y) [underbrace((1 - d(b', y', h')) dot 1, 1^("st") "term" ) + underbrace((1 - d(b', y', h')) dot (1 - psi) dot q(b'', y'), 2^("nd") "term" )]
$
...
In order to evaluate whether DPCs and CAT bonds improve welfare, we compute welfare gains relative to the baseline using a consumption-equivalent welfare metric, following the methodology adopted by #cite(<mallucci_natural_2022>, form:"prose"). 
...
_Soft-max choice rule_ #h(0.5cm) To ensure the convergence of the value function iteration, I adopt a soft-max operator as in #cite(<mallucci_natural_2022>, form:"prose"), who follows the quantitative approach implemented by #cite(<dvorkin2021restructurings>, form:"prose"). The approach consists in incorporating Type-1 Extreme Value shocks, first introduced by #cite(<mcfadden1977residential>, form:"prose"), into the goverment's optimization problem. The goal of these shocks is to smooth the government's policy functions and to mitigate sharp feedback loops between borrowing decisions and the endogenous price function, to ensure convergence in a long-term and state-contingent default framework. 
...
The parameters used to calibrate this model are directly taken from #cite(<mallucci_natural_2022>, form:"prose"), who reports precisely the empirical estimation needed to calibrate a sovereign default model with hurricane risk. The estimations are based on Jamaican data spanning 1980 to 2019 at annual frequency.
All empirically estimated parameters are reported in @Table1. As indicated by #cite(<mallucci_natural_2022>, form:"prose"), I assume that the relative risk aversion parameter $gamma$ is equal to 2, which is standard in the sovereign default literature. The probability to rejoin markets after default $theta$ is set to $frac(1,3)$, while the risk-free rate $r$ is equal to 0.0451 as in #cite(<mallucci_natural_2022>, form:"prose"). The risk-free rate corresponds to the average annual T-bill rate between 1980 and 2019. I assume that the LT decay parameter $psi$ reflects the average duration of Jamaican bonds in that same period, rescaled using the Macaulay definition of duration explored in Section 2. On the other hand, the parameters representing the probability of a major hurricane and the average associated output losses during the 1980 and 2019 period in Jamaica are also computed by #cite(<mallucci_natural_2022>, form:"prose") using data from the National Oceanic and Atmospheric Administration (NOAA). Finally, all parameters related to the income process or the hurricane shock ($rho_y$, $sigma_y$, $mu_𝓁$, and $sigma_𝓁$) are all estimated by #cite(<mallucci_natural_2022>, form:"prose") using World Bank data.
...
2. *$alpha = 0.0155$* - CAT bonds representing 1.55% of the debt stock are a much more modest CAT bond size. However, this is the value that matches empirical observations more closely. In 2021, the World Bank issued a USD 185 million CAT bond on behalf of Jamaica for hurricane protection @worldbank2021jamaicabond. In the same year, Jamaica's external debt stock amounted to USD 11,928.28 million @cpdc2025debtstock. This remains a gross approximation, as a finer analysis would consider estimating the size of the CAT bond relative to the amount of all debt servicing required throughout 2023.
...
@Figure1 illustrates the bond price schedule $q(b', y)$ as a function of next-period debt position $b'$, conditional on the two distinct realizations of effective output. The bond price schedule shows a downward-sloping relationship with debt. Indeed, higher borrowing levels $b'$ are associated with greater price discounts in both high- and low-output states. This confirms that the model captures a higher risk of default as debt levels rise. More importantly, this dynamic is much more pronounced in low-output states, during which the government faces tighter borrowing constraints. As such, this reflects the fact that in adverse states, the risk of default is heightened, consistent with both the model's assumptions and with findings from the quantitative sovereign default literature @arellano2008default. The sharp drop in bond prices for larger debt positions in the low-output state also highlights the endogenous borrowing limits imposed in the model. For low-output states, bond prices reach the null value at very low levels of borrowing, signaling a much larger default set than in the high-output states. Overall, both macroeconomic and hurricane shocks, through their joint effect on output, could significantly alter the endogenous borrowing capacity of the government.
...
@Figure3 plots the bond price schedules of all the climate-contingent debt instruments explored in this paper against the benchmark model. Overall, bond price schedules follow close trajectories to the benchmark model in their respective high or low-output realizations. However, in both cases, the relative impact of each climate-contingent instrument depends on the level of indebtedness. For low levels of debt, the CAT bond (with a relative size corresponding to 55% of the debt stock), offers a slightly higher price than benchmark, while the two DPC designs enforce a discount on the bond price. These effects are more pronounced in low output states. This reflects the fact that for modest levels of borrowing, an insurance-like instrument enhances the government's ability to smooth consumption in adverse states. In contrast, DPCs reduce the expected investor payoff by postponing debt service while providing limited relief, as debt is already low, which, therefore, implies a minor impact on the fiscal burden. 

However, at higher debt levels, especially in the high output state, while bond prices decline for all instruments, the DPCs seem to offer higher bond prices and defer the default debt threshold, particularly under the two-period relief design. This suggests that DPCs may only be valuable at elevated levels of borrowing, for which the magnitude of relief becomes significant relative to the fiscal burden (larger amounts of payments paused) and effectively frees up much more fiscal space than in low levels of debt positions. On the other hand, CAT bonds have a limited impact on borrowing costs at higher debt levels, as the insurance payout may not be sufficient to offset the heightened default risk stemming from debt servicing in the eyes of investors. 

In the low-output state, however, the effects on bond prices across all instruments are largely indistinguishable at high levels of indebtedness, indicating the limited capacity of climate-contingent instruments to provide effective relief under severe macroeconomic conditions and disaster stress.
...
The introduction of DPC instruments (1P PC and 2P PC) increases both spreads and default frequencies while marginally raising debt levels. This reflects the fact that postponing payments is associated with a higher borrowing capacity during relief periods, which consequently may raise investor concerns about long-term solvency. In contrast, CAT bonds generally reduce both spreads and default frequency, particularly at high levels of coverage of the debt stock. In fact, the CAT bond of a size equivalent to 100% of the debt stock yields the lowest spread, close to 300 basis points below the benchmark average spread, and the lowest default frequency at 4.1%, suggesting an improvement in fiscal resilience and a reduction of borrowing costs.

Overall, while DPCs may temporarily expand fiscal space, they appear to do so at the cost of higher borrowing costs and increased default risk. By comparison, CAT bonds, particularly of the largest size, seem to offer a more effective framework for reducing sovereign risk and improving financing conditions under hurricane risk.
...
@Table5 and the accompanying @Figure5 reflect the fact that all instruments yield welfare losses relative to the benchmark. This suggests that none of the instruments succeeds in improving household consumption under hurricane risk. However, the magnitude of these losses varies significantly across instruments. 
...
In contrast, CAT bonds exhibit much smaller welfare losses, especially for the smallest CAT issuance size. This pattern highlights a key advantage of the CAT bond design: by directly offsetting hurricane shocks through payouts without distorting sovereign bond payment structures, CAT bonds improve resilience while minimizing intertemporal trade-offs. Nevertheless, they still imply welfare losses as the premium paid at every state reduces the amount of resources allocated to long-term household consumption. It is worth noting that the intermediate size of the CAT bond delivers the worst welfare outcome among the three CAT instruments, likely due to the fact that it implies large premium costs with relatively modest payouts in hurricane states compared to the largest CAT bond.

Finally, the attentive reader will note that these results might only be valid under the risk-neutrality of investors and the assumption of a lack of correlation between CAT premium payments and default decisions. Future research could explore such a specification. 
\
...
In order to assess the long-term effectiveness of climate-contingent instruments, we replicate the same baseline quantitative simulations under a climate change scenario. Effectively, hurricane-related parameters are adjusted to reflect an intensification of climate change risks. Hurricane frequency is increased by 29.2% following #cite(<bhatia2018cyclone>, form:"prose") and hurricane damage is increased by 48.5% as shown by #cite(<mejia2016hurricane>, form:"prose"). These statistics were originally reported by #cite(<mallucci_natural_2022>, form:"prose") and were taken directly to conduct a similar climate change stress test on the instruments analyzed in this paper.

Overall, the patterns observed in the baseline simulations remain consistent, though the magnitude of effects is notably amplified. @Figure6 shows that bond price schedules maintain their downdard-sloping structure with respect to debt. Bond prices remain higher with CAT bonds and lower under DPCs at lower levels of indebtdness. On the other hand, for higher debt levels, especially in high-output states, bond prices under DPC designs, especially the 2PC, rise above the benchmark. These effects are much more pronounced than in the baseline. Similar conclusions can be drawn from @Figure7 about the effect of a variation in CAT bond coverage.

@Table7 confirms these patterns in simulated moments. Spreads and default frequencies increase across all specifications, but CAT bonds, especially at the largest size, continue to provide more effective relief dynamics than DPCs. Turning to welfare outcomes (@Table9 and @Figure8), we observe a fundamental shift: whereas all instruments induced losses under baseline conditions, in the climate-intensified environment, the largest CAT bond delivers a net welfare gain of 0.05%. This suggests that under more frequent and severe shocks, the insurance-like design of CAT bonds becomes not only cost-effective but welfare-enhancing. Similarly, welfare losses are also lower for DPC designs, especially the one-pause clause contract. This suggests that for higher levels of climate shocks, more designs could lead to welfare improvement. As such, as climate change continues to intensify, climate-contingent instruments will become more relevant for governments to improve welfare and benefit from effective relief conditions.
...
The quantitative evaluation highlights that all instruments expand the government's borrowing capacity. However, detailed analysis demonstrates that implications for sovereign risk and welfare vary significantly across the two classes of instruments explored. 

By pausing payments during hurricane periods, DPCs increase sovereigns' borrowing capacity, which leads to higher spreads and default frequencies due to associated investor concerns over delayed repayments. DPCs seem to provide effective relief relative to the benchmark only at high levels of indebtedness in high-output states, where the combination of substantial deferred payments and favorable economic conditions yields some relief relative to the benchmark. Nevertheless, DPCs consistently generate welfare losses under baseline conditions as higher borrowing costs crowd out consumption and, thus, undermine the government's ability to smooth household welfare over time despite providing temporal relief.
...
Importantly, when simulating a climate change scenario with more frequent and severe hurricanes, the relative performance of CAT bonds improves markedly. The largest CAT bond issuance covering 100% of the debt stock yields a net welfare gain, indicating that under more intense climate stress, the benefits of insurance outweigh the costs of its premiums. This is consistent with the fact that climate change intensification implies more disaster periods and, thus, mechanically more payouts and fewer premium payments. DPCs also exhibit milder welfare losses in a climate change scenario, suggesting that both instruments become more relevant as disaster risk increases. As such, while climate-contingent instruments may currently imply elevated costs, whether through higher borrowing spreads or insurance premiums that limit their overall effectiveness, their relevance is expected to grow as the likelihood and severity of disasters increase.

It is worth noting that these results are conditional on the risk-neutral framework and the assumption that CAT bond payouts are uncorrelated with broader macroeconomic conditions. The effects of each instrument could be reevaluated in future work under the assumption of risk-averse investors to capture more accurately sovereign pricing dynamics and their impact on sovereign risk, especially in the face of disaster risk. An early theoretical extension incorporating investor risk aversion is presented in the appendix.
...
\
A replication package with the code in Julia is available  
#show link: underline
#link("https://github.com/alibenra/Climate-and-Debt/tree/main")[
  here 
]
...
The framework follows #cite(<lizarazo_default_2013>, form:"prose"). Investors are risk-averse and exhibit decreasing absolute risk aversion (DARA), with a tolerance level towards risk highly dependent on their own wealth $W$. In this model, wealth is represented as investors' return from purchasing government assets and risk-free assets. As such, the price of bonds will be denoted as $q(b', y, W)$. Theoretically, due to risk aversion, the price will have two components:
...
Government resource constraints will remain essentially the same, but pricing will take into account the wealth of investors.
- Repayment branch
...
where $V^R (b,y,h, W)$ is the value of repayment and $V^D (y,h, W+b)$ is the value of default, given that investors lose $-b$ when the government does not repay its debt. Note that $b<0$ implies indebtedness.
...
The value of repayment satisfies the following functional equation:
$
  V^R (b,y,h, W) = max_(b') {u(y dot h + b - q(b', y, W) [b' - (1-psi)b]) + beta #math.bb("E")_(y', h')[V^o (b', y', h', W')]}
$
\
...
$
where $theta$ is the probability of rejoining markets after exclusion.

\

Following #cite(<arellano2008default>, form:"prose") and #cite(<lizarazo_default_2013>, form:"prose"), the government's default policy can be described through default sets $D(b|W)$.
\
*Definition 1.* #h(0.5cm) Let $D(b|W)$ denote the default set, which consists of the equilibrium set of exogenous state pairs $ (y, h)$ for which default is optimal when the government's asset holdings are $b$, conditional on a given level of investor wealth $W$. Formally:
$
...
The periodic utility of households displays a constant coefficient of relative risk aversion $gamma^L>0$, such that:
...
$
  W = w^("TB") + w
$
where $w= -b$. If the government defaults, the representative investor's wealth becomes $W - w= w^("TB")$


#box[Investors' actions in this framework are constrained by government's decisions. Therefore, investors evolve either in the repayment branch or the default branch. This is determined by the government at the beginning of each period. Investors' resource constraints are then defined as follows:
...
- Government repayment branch
$
  V^R_L (b,y,W) = max_(w', (w^("TB"))') {v(X + W - q^f (w^("TB"))' - q(b', y, W)[w' - (1-psi)w]) + beta #math.bb("E")_(y')[V^o (b, y,  W)]}
$
- Government default branch
$
  V^D_L (y, w^("TB")) = max_((w^("TB"))') {v(X + w^("TB") - q^f (w^("TB"))') + beta #math.bb("E")_(y') [theta V^o (0, y', (w^("TB"))') + (1-theta) V^D (y', (w^("TB"))')]}
$
...
#show bibliography: set par(spacing: 3.5em)
